export const SERVICE_CATEGORIES = [
  {
    ...
    description:
      "Restore the beauty and elegance of your favourite leather bags with our expert cleaning and repair solutions. From deep cleaning and conditioning to colour touch-ups and precision repairs, we bring back their original charm while protecting them for years to come. Whether it's luxury designer pieces, vintage leather, or everyday favourites, we provide care that's as exceptional as your accessories. Loved and trusted by clients across India, we deliver artistry, attention, and a touch of royalty with every restoration.",
    highlight: "Give your leather bag the professional care it deserves.",
    before: "/images/OurServices/Dior bag color change - Before.png",
    after: "/images/OurServices/Dior bag color change - After.png",
  ...
  },
  {
    ...
    heading: "Best Shoes Cleaning and Repair Service",
    description:
  ...
  },
  {
    ...
    heading: "Leather Sofa Cleaning and Repair Services",
    description:
  ...
  },
  {
    ...
    heading: "Best Leather Jacket Repair and Cleaning Service",
    description:
