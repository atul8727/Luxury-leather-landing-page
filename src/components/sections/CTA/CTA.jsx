  ...
  return (
    <section className="relative overflow-hidden bg-navbar py-20 lg:py-24">
      <div className="absolute inset-0">
        <Image src="/images/cta/cta-bag.jpg" alt="Restored leather bag ready for delivery" fill sizes="100vw" className="object-cover opacity-30" />
      </div>
      <Container className="relative flex flex-col items-center gap-6 text-center">
        ...
        <Button href="#contact" variant="light" onClick={() => window.dispatchEvent(new Event(OPEN_ENQUIRY_MODAL_EVENT))}>
          Get a Free Quote
        </Button>
      </Container>
    </section>
